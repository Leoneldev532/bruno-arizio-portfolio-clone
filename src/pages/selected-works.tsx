...
const SelectedWorks = () => {
  ...
  return (
    <div className="flex   flex-col justify-center items-center relative w-full">
      <div
        className={`fixed pt-32 lg:pt-10 show-project-container ${
          width < 850 ? "pointer-events-auto" : "pointer-events-none"
        } opacity-0 z-0 bg-white/95 backdrop-grayscale-100 left-0 h-full w-full top-6 flex justify-center items-start`}
        onClick={() => {
